  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._click = function(e) {
      ...
      //if ($target.is('.toggler')) {
        ...
        if (node_element && node_element.node.hasChildren() && (!node_element.node.is_open || $target.is('.toggler'))) {
          node_element.toggle();
          this._saveState();
          e.preventDefault();
      ...
      //}
      //Pulled this out of being an 'else if' because clicking these can open folders
  ...
  SelectNodeHandler = (function() {
    ...
    SelectNodeHandler.prototype.selectNode = function(node, must_open_parents) {
      //dw
      console.log("selectNode Called in jqtree node = " + node);
      var parent;
