...
/** Action to open a new Requirement tab when the server returns with an updated copy of the requirement
 * 
 * @author Mitchell
 *
 */

public class OpenRequirementTabAction implements IRetreiveRequirementByIDControllerNotifier {
	...
	public OpenRequirementTabAction(MainTabController tabController, Requirement oldRequirement) {
	 ...
	 * 
	 * @param requirement The requirement to view / edit
	 */
	...
	/** Called when the server returns a requirement
	 *  In this case we open a copy of the updated requirement
	 *  
	 *  @param requirement The updated requirement returned from the server
	 */
	...
	/** Called if there was an error fetching the requirement from the sever
	 * In this case we open the old, possibly outdated requirement
	 * 
	 * @param errorMessage The error message the server returned
	 */
	...
	public void errorReceivingData(String errorMessage) {
		...
		System.out.println("Error fetching requirement from server: " + errorMessage);
