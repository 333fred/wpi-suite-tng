...
public class RequirementTableView extends Tab implements IToolbarGroupProvider,
	...
	/**
	 * Gets the singleton instance of the table view. If
	 * {@link #getInstance(MainTabController)} hasn't been called yet, this will
	 * be null
	 * 
	...
	/**
	 * Gets the singleton instance of the view. If it hasn't been initialized,
	 * then it is initialized with the given tab controller
	 * 
	 * @param tabController
	 *            the controller to initialize with, if necessary
	 * @return the singleton view
	 */
	public static RequirementTableView getInstance(
	...
	@Override
	public Component getTabComponent(final MainTabController newTabController) {
		return new UnclosableTabComponent(newTabController, "Requirements");
	}
	...
	/**
	 * Creates a new filter for an iteration of the given name
	 * 
	 * @param IterationName
	 *            the name to filter
	 */
	...
	/**
	 * Filters based on a given string
	 * 
	 * @param filterText
	...
	/**
	 * Applies filters to the given row sorter
	 * 
	 * @param rs
	 *            the sorter to apply to
	 */
	@SuppressWarnings ("rawtypes")
