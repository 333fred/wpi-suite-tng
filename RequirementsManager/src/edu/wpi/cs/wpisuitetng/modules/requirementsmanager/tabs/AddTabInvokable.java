...
/** Class used to add a tab on the swing thread, will hopefully stop UI corruption with unclosable tabs
 * 
 * @author Mitchell
 *
 */
...
public class AddTabInvokable implements Runnable {
	 ...
	 * 
	 * @param tabView The MainTabView to add the tab in
	 * @param title The title of the tab to add
	 * @param icon The icon of the tab to add 
	 * @param tab The component of the tab to add
	 * @param toolTip The tooltip of the tab to add
	 */
	
	public AddTabInvokable(MainTabView tabView, String title, Icon icon, Tab tab, String toolTip) {
