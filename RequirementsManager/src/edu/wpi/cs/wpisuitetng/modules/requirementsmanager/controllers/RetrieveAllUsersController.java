...
public class RetrieveAllUsersController {
	...
	public void GetUsers() {
		final RequestObserver requestObserver = new RetrieveAllUsersRequestObserver(
				this);
		Request request;
	...
	/**
	 * Called by the [@link RetrieveAllUsersRequestObserver] when there is an
	...
	/**
	 * Called by the [@link RetrieveAllUsersRequestObserver] when data
