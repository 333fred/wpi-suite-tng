...
public class MakeTaskPanel extends JPanel{
	...
	public MakeTaskPanel(Requirement model, DetailPanel parentView) {
		...
		addtaskLabel = new JLabel("Add a new task:");
		...
		layout.putConstraint(SpringLayout.NORTH, taskName, VERTICAL_PADDING, SpringLayout.SOUTH, addtaskLabel);
		layout.putConstraint(SpringLayout.WEST, taskName, 0, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.EAST, taskName, 0, SpringLayout.EAST, this);
		layout.putConstraint(SpringLayout.NORTH, taskFieldPane, VERTICAL_PADDING, SpringLayout.SOUTH, taskName);
