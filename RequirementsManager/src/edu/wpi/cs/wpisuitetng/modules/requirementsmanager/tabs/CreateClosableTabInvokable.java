...
/** Class to invoke the updating of the tab later, calling setTabComponent at in a different thread than the 
 * swing thread can cause wierd issues, this should solve them
 * 
 * @author Mitchell
 *
 */
...
public class CreateClosableTabInvokable implements Runnable {
	 ...
	 * @param index The index of hte tab to change 
	 * @param tabToUpdate Tab object represeting the tab to change
	 */
	
	public CreateClosableTabInvokable(MainTabView tabView, int index,Tab tabToUpdate) {
